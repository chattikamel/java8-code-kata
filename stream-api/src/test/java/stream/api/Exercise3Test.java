...
public class Exercise3Test extends ClassicOnlineStore {
    ...
    public void howManyItemsWanted() {
         ...
         */
        long sum = customerList.stream().map(customer -> customer.getWantToBuy().size()).mapToLong(value -> value).sum();
    ...
    public void youngestCustomer() {
         ...
         * Don't use {@link Stream#sorted}
         */
        Comparator<Customer> comparator = (o1, o2) -> Integer.compare(o2.getAge(), o1.getAge());
        Optional<Customer> youngestCustomer = customerList.stream().max(comparator);
